  ...
  const logSuggestionOutcome = useCallback((
    ...
    const apiBase = (typeof import.meta !== 'undefined' &&
      (import.meta as Record<string, unknown>).env
        ? ((import.meta as Record<string, unknown>).env as Record<string, unknown>).VITE_API_URL as string | undefined
        : undefined) ?? '';
              ...
              {project.tracks.map(track => (
                ...
                >
                  ...
                  <div style={{ display:'flex', alignItems:'center', gap:5 }}>
                    ...
                    <span style={{ fontSize:9, fontWeight:600, color:C.text, letterSpacing:'.05em', truncate:true, overflow:'hidden', textOverflow:'ellipsis', whiteSpace:'nowrap' }}>
                      {track.name}
                    </span>
