...
export function broadcastDSPParams(sessionId, params) {
...
export function mountAgentWS(server) {
    if (!AGENT_TOKEN) {
        process.stderr.write('[ws-agent] AGENT_SERVICE_TOKEN not set — WebSocket agent endpoint disabled\n');
        return;
    }
