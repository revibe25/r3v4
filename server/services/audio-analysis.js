...
let AudioContext = null; // typed any: node-web-audio-api ships no .d.ts
try {
...
export async function analyzeAudioFile(filePath) {
    if (!AudioContext) {
        throw new Error('node-web-audio-api is not installed. Run: cd server && pnpm add node-web-audio-api');
    }
