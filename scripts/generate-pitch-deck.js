...
function createPitchDeck() {
  console.log('🎨 Generating WaveLab Production-Grade Investor Pitch Deck...\n');
  ...
  // ==================== SLIDE 1: TITLE ====================
  console.log('📄 Creating Slide 1: Title + Vision...');
  ...
  console.log('📄 Creating Slide 4: Product Demo...');
  ...
  // ==================== SLIDE 6: TECHNOLOGY ====================
  console.log('📄 Creating Slide 6: Technology Stack...');
  ...
  console.log('📄 Creating Slide 7: Competitive Advantages...');
  ...
  console.log('📄 Creating Slide 8: Business Model...');
  ...
  console.log('📄 Creating Slide 9: Go-to-Market Strategy...');
  ...
  console.log('📄 Creating Slide 10: Competitive Landscape...');
  ...
  // ==================== SLIDE 11: ROADMAP ====================
  console.log('📄 Creating Slide 11: Product Roadmap...');
  ...
  console.log('📄 Creating Slide 12: Vision & Close...');
  ...
  pptx.writeFile({ fileName: filename })
    .then(() => {
      ...
      console.log(`📈 12 slides of investor-grade content`);
      console.log('🚀 Ready to raise your Series A!\n');
      console.log('💡 Next steps:');
      console.log('   1. Review each slide for content accuracy');
      console.log('   2. Replace placeholder data with real metrics');
      console.log('   3. Add your team photos/logos if needed');
      console.log('   4. Practice your delivery (8-10 minutes)\n');
    })
    .catch(err => {
...
try {
  ...
  console.error('📦 Install it with: npm install pptxgenjs');
  console.error('   Or globally: npm install -g pptxgenjs\n');
  process.exit(1);
}
