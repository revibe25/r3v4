...
- Name: happy-path.spec.ts >> R3 v4 Happy Path >> Server responds to requests
- Location: tests/happy-path.spec.ts:14:3
...
> 16 |     expect(page.url()).toContain('r3v4');
  ...
  17 |   });
  18 | 
  19 |   test('Root path serves SPA', async ({ request }) => {
