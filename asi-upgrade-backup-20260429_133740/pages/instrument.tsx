...
.ag-frame [data-testid^="piano-key-"].rounded-b-md.bg-background {
  background: #000000 !important;
...
/* Time display */
.ag-frame [class*="bg-background\/40"] {
  background: var(--ag-black) !important;
  border-radius: 0 !important;
}
...
.ag-frame [class*="bg-accent\/10"] {
  background: rgba(163,230,53,.08) !important;
  border-color: var(--ag-acid-d) !important;
  border-radius: 0 !important;
}
.ag-frame [class*="text-accent"], .ag-frame [class*="text-accent"] {
  color: var(--ag-acid) !important;
}
        ...
        <div className="ag-frame">
          ...
          <footer className="ag-footer">
            ...
            <div className="ag-footer-right" data-testid="text-tech">
              Web Audio API · Web MIDI API · IndexedDB
              <span className="ag-ver-tag">v3.0</span>
            </div>
          </footer>
        </div>
