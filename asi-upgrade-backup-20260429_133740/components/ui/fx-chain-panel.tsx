    ...
    <div className="w-64 bg-card border-l border-border flex flex-col">
      ...
      <div className="h-12 border-b border-border flex items-center justify-between px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="text-sm font-medium text-foreground">FX Chain</span>
        </div>
      </div>
        ...
        <div className="flex-1 flex flex-col overflow-hidden">
          ...
          {selectedTrackName && (
            <div className="px-4 py-2 border-b border-border text-xs text-muted-foreground">
              Track: <span className="text-foreground font-medium">{selectedTrackName}</span>
            </div>
          )}
                ...
                >
                  <div className="flex items-center justify-between mb-2">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-sm font-medium text-foreground">{fx.type}</span>
                    </div>
                    <div className="flex items-center gap-1">
                      ...
                      {onRemoveFX && (
                        <button
                          ...
                          className="px-2 py-1 text-xs rounded bg-muted text-muted-foreground hover:bg-red-600 hover:text-foreground transition-colors"
                        >
                          ×
                        </button>
                      )}
          ...
          <div className="border-t border-border p-4 space-y-2">
            ...
            {(['EQ', 'Compressor', 'Delay', 'Reverb', 'Distortion'] as FXType[]).map((fxType) => (
              <button
                ...
                className="w-full py-2 bg-muted hover:bg-muted text-foreground text-sm rounded transition-colors"
              >
                + {fxType}
              </button>
            ))}
