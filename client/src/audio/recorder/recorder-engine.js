...
export class RecorderEngine {
    ...
    async init() {
        await this.context.audioWorklet.addModule(new URL("./recorder-worklet.ts", import.meta.url));
        this.node = new AudioWorkletNode(this.context, "recorder-worklet");
...
let _recorderEngine = null;
export function getRecorderEngine() {
    if (!_recorderEngine)
        _recorderEngine = new RecorderEngine();
