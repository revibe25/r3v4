...
class VSTProcessor extends AudioWorkletProcessor {
    ...
    async initializeWasm(options) {
        try {
            ...
            this.wasmInstance = await WebAssembly.instantiate(options.wasmModule, imports);
    ...
    process(inputs, outputs, parameters) {
        ...
        try {
            ...
            this.wasmExports.process(this.inputBufferPtr, this.outputBufferPtr, frameCount, this.inputChannels, this.outputChannels);
