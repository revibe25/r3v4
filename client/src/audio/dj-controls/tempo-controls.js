...
export class TempoControl {
     ...
     */
    setBpm(bpm) {
        const clampedBpm = Math.max(DJ_CONSTRAINTS.MIN_BPM, Math.min(DJ_CONSTRAINTS.MAX_BPM, bpm));
    ...
    setPitchShift(semitones) {
        const clampedShift = Math.max(DJ_CONSTRAINTS.MIN_PITCH_SHIFT, Math.min(DJ_CONSTRAINTS.MAX_PITCH_SHIFT, semitones));
     ...
     */
    calculateAccelTime(targetBpm, accelerationMs) {
     ...
     */
    accelerateToTempo(targetBpm, durationMs) {
