...
export class PerformanceMonitor {
     ...
     */
    async measureComponentAsync(name, fn) {
        const startTime = performance.now();
     ...
     */
    recordComponentMetric(name, duration) {
...
export function usePerformanceMonitor() {
    ...
    return {
        ...
        getBottlenecks: (count) => monitor.getBottlenecks(count),
        getReport: () => monitor.getReport(),
        measureComponent: (name, fn) => monitor.measureComponent(name, fn),
