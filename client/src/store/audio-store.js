...
// STORE
// ============================================
export const useAudioStore = create()(devtools(persist((set, get) => ({
    ...initialState,
    // ============================================
    // AUDIO CONTEXT
    // ============================================
    ...
    saveProject: () => {
        const { channels, masterVolume, currentPosition, projectName, sampleRate, } = get();
        const state = {
            version: '1.0.0',
            timestamp: Date.now(),
            metadata: {
...
// SELECTORS
// ============================================
export const selectIsPlaying = (state) => state.transportState === 'playing' || state.transportState === 'recording';
export const selectChannelCount = (state) => state.channels.size;
export const selectHasSoloChannels = (state) => state.soloChannels.size > 0;
