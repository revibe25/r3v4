...
// ── Component ─────────────────────────────────────────────────────────────────
export function Oscilloscope({ data, width = 400, height = 120, color = "var(--green-400)", background = "#0a0a0a", lineWidth = 1.5, ariaLabel = "Waveform oscilloscope", }) {
    ...
    return (_jsx("canvas", { ref: canvasRef, "aria-label": ariaLabel, role: "img", style: { display: "block", width, height } }));
}
