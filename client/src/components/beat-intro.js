...
const STEP_MAP = Array.from({ length: STEPS }, (_, s) => BEAT.filter(b => b.step === s));
// ── Web Audio synthesis ────────────────────────────────────────────────────────
...
export function BeatIntro({ onTrigger, disabled = false }) {
    ...
    return (_jsxs("div", { style: {
            ...
            minHeight: "100vh",
            padding: "20px",
            backgroundImage: "repeating-linear-gradient(0deg,transparent,transparent 3px,rgba(255,255,255,.006) 3px,rgba(255,255,255,.006) 4px)," +
      ...
      ` }), _jsx("div", { style: {
                    ...
                    borderLeft: "3px solid #a3e635", paddingLeft: 14,
                }, children: [_jsxs("div", { children: [_jsx("div", { style: { fontSize: 8, letterSpacing: "0.4em", color: "#a3e635", textTransform: "uppercase", marginBottom: 4 }, children: "R3 \u00B7 NATIVE / INTRO SEQUENCE" }), _jsxs("div", { style: { fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: 24, letterSpacing: "-0.02em", lineHeight: 1 }, children: ["BEAT PLAYER ", _jsx("span", { style: { color: "#a3e635" }, children: "/" }), " KEY POSITION MONITOR"] })] }), _jsxs("div", { style: { textAlign: "right" }, children: [_jsx("div", { style: { fontSize: 8, letterSpacing: "0.25em", color: "rgba(255,255,255,0.25)", textTransform: "uppercase" }, children: "126 BPM \u00B7 16-STEP \u00B7 SYNTHESIZED" }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6, justifyContent: "flex-end", marginTop: 4 }, children: [_jsx("div", { style: {
                                            width: 8, height: 14,
                                            background: playing ? "#a3e635" : "#1c1c1c",
                                            boxShadow: playing ? "0 0 8px #a3e635" : "none",
                                            animation: playing ? "blink 1s step-end infinite" : "none",
                                        } }), _jsx("span", { style: { fontSize: 9, letterSpacing: "0.2em", color: playing ? "#a3e635" : "var(--dj-dimmer)", textTransform: "uppercase" }, children: playing ? "LIVE" : "STANDBY" })] })] })] }), _jsxs("div", { style: { display: "flex", alignItems: "center", gap: 20, marginBottom: 20 }, children: [_jsx("button", { onClick: playing ? stop : start, disabled: disabled && !playing, style: {
                            ...
                            flexShrink: 0,
                        }, children: playing ? "■  STOP" : disabled ? "ENGINE STANDBY" : "▶  PLAY INTRO" }), [
                    ...
                    ].map(({ label, val, big, col }) => (_jsxs("div", { children: [_jsx("div", { style: { fontSize: 7, letterSpacing: "0.3em", color: "rgba(255,255,255,0.25)", textTransform: "uppercase", marginBottom: 2 }, children: label }), _jsx("div", { style: { fontFamily: "'Syne',sans-serif", fontWeight: 800, fontSize: big ? 32 : 26, color: col, lineHeight: 1,
                                    textShadow: col === "#a3e635" && playing ? "0 0 18px rgba(163,230,53,0.5)" : "none",
                                }, children: val })] }, label))), _jsx("div", { style: {
                        ...
                        }, children: "126" })] }), _jsxs("div", { style: { marginBottom: 20 }, children: [_jsx("div", { style: { fontSize: 7, letterSpacing: "0.3em", color: "rgba(255,255,255,0.22)", textTransform: "uppercase", marginBottom: 6 }, children: "STEP POSITION \u2014 BEAT GRID" }), _jsx("div", { style: { display: "flex", gap: 2 }, children: Array.from({ length: STEPS }, (_, s) => {
                            const hits = STEP_MAP[s];
                            const active = s === step;
                            return (_jsxs("div", { style: { flex: 1, position: "relative" }, children: [_jsx("div", { style: {
                                            height: 32,
                                            background: active
                                                ? "#a3e635"
                                        ...
                                        } }), _jsx("div", { style: { display: "flex", gap: 1, justifyContent: "center", marginTop: 2 }, children: hits.slice(0, 4).map((h, i) => (_jsx("div", { style: {
                                                width: 4, height: 4,
                                                background: CATS[h.pad].color,
                                                opacity: active ? 1 : 0.55,
                                                boxShadow: active ? `0 0 4px ${CATS[h.pad].color}` : "none",
                                            } }, i))) })] }, s));
                        }) }), _jsx("div", { style: { display: "flex", marginTop: 3 }, children: [1, 2, 3, 4].map(b => (_jsx("div", { style: { flex: 4, fontSize: 7, color: "rgba(255,255,255,0.18)", letterSpacing: "0.1em", paddingLeft: 2 }, children: b }, b))) })] }), _jsxs("div", { style: { display: "grid", gridTemplateColumns: "1fr 260px", gap: 16 }, children: [_jsxs("div", { children: [_jsx("div", { style: { fontSize: 7, letterSpacing: "0.3em", color: "rgba(255,255,255,0.22)", textTransform: "uppercase", marginBottom: 8 }, children: "PAD GRID \u2014 SAMPLE EXECUTION POSITIONS" }), _jsx("div", { style: { display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: 4 }, children: Array.from({ length: 16 }, (_, i) => {
                                    const cat = CATS[i];
                                    ...
                                    const col = (i % 4) + 1;
                                    return (_jsxs("div", { className: pop ? "pad-pop" : "", style: {
                                        ...
                                        }, children: [_jsxs("div", { style: { position: "absolute", inset: 0, padding: 8, display: "flex", flexDirection: "column", justifyContent: "space-between" }, children: [_jsxs("div", { style: { display: "flex", justifyContent: "space-between", alignItems: "flex-start" }, children: [_jsx("span", { style: {
                                                                    fontSize: 9, fontWeight: 700, letterSpacing: "0.05em",
                                                                    color: hit ? cat.color : "rgba(255,255,255,0.22)",
                                                                    textShadow: hit ? `0 0 8px ${cat.color}` : "none",
                                                                }, children: String(i + 1).padStart(2, "0") }), hasNote && (_jsx("div", { style: {
                                                                    width: 5, height: 5,
                                                                    background: cat.color,
                                                                    opacity: hit ? 1 : 0.35,
                                                                    boxShadow: hit ? `0 0 6px ${cat.color}` : "none",
                                                                } }))] }), _jsxs("div", { children: [_jsx("div", { style: { fontSize: 6, letterSpacing: "0.18em", color: hit ? cat.color : "rgba(255,255,255,0.18)", textTransform: "uppercase", lineHeight: 1 }, children: cat.label }), _jsxs("div", { style: { fontSize: 6, letterSpacing: "0.1em", color: "rgba(255,255,255,0.18)", marginTop: 1 }, children: ["R", row, "\u00B7C", col] }), _jsx("div", { style: { marginTop: 4, height: 2, background: "rgba(255,255,255,0.06)", overflow: "hidden" }, children: _jsx("div", { style: {
                                ...
                                }) }), _jsx("div", { style: { display: "flex", gap: 20, marginTop: 10 }, children: [
                                    { label: "KICK", color: "#ef4444" },
                                    { label: "SNARE", color: "var(--track-orange)" },
                                    { label: "HI-HAT", color: "#a3e635" },
                                    { label: "PERC", color: "var(--accent-purple)" },
                                ].map(({ label, color }) => (_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [_jsx("div", { style: { width: 8, height: 8, background: color } }), _jsx("span", { style: { fontSize: 7, letterSpacing: "0.2em", color: "rgba(255,255,255,0.35)", textTransform: "uppercase" }, children: label })] }, label))) }), _jsxs("div", { style: { marginTop: 16, borderTop: "1px solid #1c1c1c", paddingTop: 12 }, children: [_jsx("div", { style: { fontSize: 7, letterSpacing: "0.3em", color: "rgba(255,255,255,0.22)", textTransform: "uppercase", marginBottom: 8 }, children: "PATTERN MAP \u2014 ALL 16 PADS" }), ["KICK", "SNARE", "HI-HAT", "PERC"].map((cat, ri) => {
                                        ...
                                        return (_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 8, marginBottom: 5 }, children: [_jsx("span", { style: { fontSize: 6, letterSpacing: "0.15em", color: "rgba(255,255,255,0.22)", textTransform: "uppercase", minWidth: 44 }, children: cat }), _jsx("div", { style: { display: "flex", gap: 1, flex: 1 }, children: Array.from({ length: 16 }, (_, s) => {
                                    ...
                                    })] })] }), _jsxs("div", { style: { display: "flex", flexDirection: "column", gap: 0 }, children: [_jsxs("div", { style: {
                                    ...
                                    position: "relative", overflow: "hidden",
                                }, children: [_jsx("div", { style: { fontSize: 7, letterSpacing: "0.3em", color: "rgba(255,255,255,0.25)", textTransform: "uppercase", marginBottom: 10 }, children: "KEY EXECUTION POSITION" }), lastHit ? (() => {
                                        ...
                                        return (_jsxs(_Fragment, { children: [_jsxs("div", { style: {
                                                    ...
                                                    }, children: ["PAD ", String(lastHit.pad + 1).padStart(2, "0")] }), _jsx("div", { style: { fontSize: 10, letterSpacing: "0.18em", color: c.color, textTransform: "uppercase", marginTop: 2, fontWeight: 600 }, children: PAD_NAMES[lastHit.pad] }), _jsxs("div", { style: { display: "flex", gap: 16, marginTop: 8 }, children: [_jsxs("div", { children: [_jsx("div", { style: { fontSize: 6, letterSpacing: "0.25em", color: "rgba(255,255,255,0.25)", textTransform: "uppercase" }, children: "POSITION" }), _jsxs("div", { style: { fontSize: 11, fontWeight: 600, color: "rgba(255,255,255,0.7)", letterSpacing: "0.1em" }, children: ["ROW ", row, " / COL ", col] })] }), _jsxs("div", { children: [_jsx("div", { style: { fontSize: 6, letterSpacing: "0.25em", color: "rgba(255,255,255,0.25)", textTransform: "uppercase" }, children: "STEP" }), _jsxs("div", { style: { fontSize: 11, fontWeight: 600, color: "rgba(255,255,255,0.7)", letterSpacing: "0.1em" }, children: [String(lastHit.step + 1).padStart(2, "0"), " / 16"] })] }), _jsxs("div", { children: [_jsx("div", { style: { fontSize: 6, letterSpacing: "0.25em", color: "rgba(255,255,255,0.25)", textTransform: "uppercase" }, children: "MIDI VEL" }), _jsx("div", { style: { fontSize: 11, fontWeight: 600, color: c.color, letterSpacing: "0.1em" }, children: Math.round(lastHit.vel * 127) })] })] }), _jsx("div", { style: { marginTop: 10, height: 3, background: "rgba(255,255,255,0.06)" }, children: _jsx("div", { style: {
                                    ...
                                    })() : (_jsxs("div", { style: { paddingTop: 16 }, children: [_jsx("div", { style: { fontSize: 8, letterSpacing: "0.2em", color: "rgba(255,255,255,0.12)", textTransform: "uppercase" }, children: "Awaiting trigger\u2026" }), _jsx("div", { style: { marginTop: 8, fontSize: 7, color: "rgba(255,255,255,0.08)", lineHeight: 1.8 }, children: ["PAD 01 · KICK MAIN", "PAD 05 · SNARE", "PAD 09 · HH OPEN", "PAD 13 · RIM SHOT"].map(l => (_jsx("div", { children: l }, l))) })] }))] }), _jsxs("div", { style: { border: "1px solid var(--dj-surface2)", background: "rgba(0,0,0,0.3)", flex: 1 }, children: [_jsx("div", { style: { padding: "8px 10px", borderBottom: "1px solid var(--dj-surface2)", fontSize: 7, letterSpacing: "0.3em", color: "rgba(255,255,255,0.22)", textTransform: "uppercase" }, children: "LIVE HIT LOG" }), _jsx("div", { style: { overflow: "hidden" }, children: hitLog.length === 0 ? (_jsx("div", { style: { padding: "12px 10px", fontSize: 8, letterSpacing: "0.15em", color: "rgba(255,255,255,0.1)", textTransform: "uppercase" }, children: "No events yet" })) : hitLog.map((h, idx) => {
                                            const c = CATS[h.pad];
                                            return (_jsxs("div", { className: "log-entry", style: {
                                                ...
                                                }, children: [_jsxs("span", { style: { fontSize: 7, color: "rgba(255,255,255,0.22)", minWidth: 22 }, children: ["S", String(h.step + 1).padStart(2, "0")] }), _jsx("div", { style: { width: 5, height: 5, background: c.color, flexShrink: 0 } }), _jsxs("div", { style: { flex: 1, minWidth: 0 }, children: [_jsx("div", { style: { fontSize: 8, fontWeight: 600, letterSpacing: "0.1em", color: idx === 0 ? c.color : "rgba(255,255,255,0.55)", textTransform: "uppercase", lineHeight: 1 }, children: c.label }), _jsxs("div", { style: { fontSize: 7, color: "rgba(255,255,255,0.25)", lineHeight: 1, marginTop: 1 }, children: ["PAD ", String(h.pad + 1).padStart(2, "0"), " \u00B7 R", Math.floor(h.pad / 4) + 1, "\u00B7C", (h.pad % 4) + 1] })] }), _jsx("div", { style: { fontSize: 7, color: "rgba(255,255,255,0.22)", letterSpacing: "0.05em" }, children: Math.round(h.vel * 127) }), _jsx("div", { style: { display: "flex", gap: 1 }, children: Array.from({ length: 5 }, (_, i) => (_jsx("div", { style: { width: 2, height: 8, background: i < Math.round(h.vel * 5) ? c.color : "#1c1c1c" } }, i))) })] }, h.id));
                                        }) })] })] })] })] }));
}
