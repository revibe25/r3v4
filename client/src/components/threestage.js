...
export const ThreeStage = memo(function ThreeStage({ children, shake, audioReactive = false, colorBase = '#1a0066', colorAccent = 'var(--accent-neon-green)', }) {
    return (_jsxs(Canvas, { shadows: true, dpr: [1, 2], camera: { position: BASE_POSITION.toArray(), fov: 42 }, gl: { antialias: true, powerPreference: 'high-performance' }, children: [_jsx("color", { attach: "background", args: ['#050505'] }), _jsx("ambientLight", { intensity: 0.25 }), _jsx("hemisphereLight", { intensity: 0.35, groundColor: "var(--dj-surface2)" }), _jsx("directionalLight", { castShadow: true, position: [6, 12, 6], intensity: 1.4, "shadow-mapSize": [2048, 2048], "shadow-bias": -0.0001 }), _jsx(CameraRig, { shake: shake }), audioReactive && (_jsx(AudioReactiveScene, { colorBase: colorBase, colorAccent: colorAccent, animateCamera: false })), audioReactive && (_jsx(WaveformMesh, { trackIndex: -1, useFft: true, binCount: 128, width: 8, height: 0.8, depth: 0.03, colorLow: colorAccent, colorHigh: "var(--white)", position: [0, -2.5, 0] })), children, _jsxs(EffectComposer, { enableNormalPass: false, children: [_jsx(Bloom, { intensity: 1.6, luminanceThreshold: 0.15, luminanceSmoothing: 0.9, mipmapBlur: true }), _jsx(Vignette, { eskil: false, offset: 0.15, darkness: 0.6 })] })] }));
});
// ─── CameraRig ────────────────────────────────────────────────────────────────
// Fixes:
