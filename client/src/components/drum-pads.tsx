...
const PAD_CATEGORIES: Record<number, { label: string; color: string }> = {
  ...
  4:  { label: 'SNARE', color: '#f97316' },
  5:  { label: 'SNARE', color: '#f97316' },
  6:  { label: 'SNARE', color: '#f97316' },
  7:  { label: 'SNARE', color: '#f97316' },
  8:  { label: 'HI-HAT', color: '#a3e635' },
  9:  { label: 'HI-HAT', color: '#a3e635' },
  10: { label: 'HI-HAT', color: '#a3e635' },
  11: { label: 'HI-HAT', color: '#a3e635' },
  12: { label: 'PERC',  color: '#8b5cf6' },
  13: { label: 'PERC',  color: '#8b5cf6' },
  14: { label: 'PERC',  color: '#8b5cf6' },
  15: { label: 'PERC',  color: '#8b5cf6' },
};
        ...
        return (
          ...
          >
            ...
            >
              ...
              <div className="absolute left-2 right-2 top-1.5 h-1.5 rounded-full bg-black/20 overflow-hidden z-10">
                <div
            ...
            {viewMode !== 'compact' && isLoaded && (
              <div className="absolute -top-1 -right-1 opacity-0 group-hover:opacity-100 transition-opacity flex gap-0.5 z-20">
                <button
                  ...
                  className={clsx(
                    'p-0.5 rounded-full text-white hover:scale-110 transition-transform',
                ...
                <button
                  ...
                  className="p-0.5 bg-blue-500/80 rounded-full text-white hover:scale-110 transition-transform"
                  title="Copy sample"
                >
                ...
                <button
                  ...
                  className="p-0.5 bg-background0/80 rounded-full text-white hover:scale-110 transition-transform"
  ...
  return (
    ...
    >
        ...
        <div className="flex items-center gap-2 min-w-0">
          ...
          <div className="min-w-0">
            <h3 className="text-xs font-semibold text-foreground/90 flex items-center gap-1.5 leading-none">
              ...
              {recordingMode && (
                <span className="px-1.5 py-0.5 bg-red-500 text-white text-[9px] rounded-full animate-pulse flex items-center gap-1 leading-none">
      ...
      <div className="p-2.5 space-y-2.5 overflow-y-auto" style={{ scrollbarWidth: 'thin', scrollbarColor: '#a3e635 transparent' }}>
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-2">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <button
                      ...
                      className={clsx(
                        ...
                        macroEnabled ? 'bg-purple-500 text-white' : 'bg-muted/40 text-foreground/40'
                      )}
                    ...
                    {MACRO_PARAMS.map(p => (
                      <button
                        ...
                        className={clsx(
                          ...
                          macroParams.has(p) ? 'bg-purple-500/80 text-white' : 'bg-muted/30 text-foreground/40'
                        )}
                      >{p}</button>
                    ))}
                  </div>
                ...
                <div className="rounded-md border border-border/30 p-2 space-y-1.5"
                  ...
                  <button
                    ...
                    className="w-full h-6 text-[9px] font-bold rounded bg-amber-500/80 text-white hover:bg-amber-500 transition-all"
        ...
        {success && (
          <div className="flex items-center gap-1.5 p-1.5 bg-green-500/10 border border-green-500/20 rounded-md text-green-700 dark:text-green-400 text-[10px] animate-in slide-in-from-top-2">
              ...
              <div className="flex items-center gap-2">
                ...
                <button
                  ...
                  className={clsx(
                    ...
                    seqPlaying ? 'bg-destructive text-white' : 'bg-primary text-primary-foreground'
                  )}
                >
          ...
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              style={{
                ...
                color: padMutes.has(selectedPadIndex) ? '#f87171' : 'rgba(255,255,255,0.3)',
              }}
            >M</button>
            <button
              ...
              style={{
                ...
                color: soloedPad === selectedPadIndex ? '#fbbf24' : 'rgba(255,255,255,0.3)',
              }}
            >S</button>
            {/* Sample count */}
            ...
            >
              ...
              >
                ...
                <Select value={selectedPad} onValueChange={setSelectedPad} disabled={isLoading}>
                  <SelectTrigger className="w-full h-5 text-[8px] rounded-sm px-1.5 border-border/40 bg-black/20">
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
                    {pads.map((pad, i) => (
                ...
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className="flex-1 h-5 flex items-center justify-center gap-1 rounded-sm border border-border/40 bg-black/20 hover:bg-[#a3e635]/10 hover:border-[#a3e635]/40 text-muted-foreground hover:text-[#a3e635] transition-all disabled:opacity-30 text-[7px] font-mono tracking-wider"
                  >
                  ...
                  <button
                    ...
                    className="flex-1 h-5 flex items-center justify-center rounded-sm border border-border/40 bg-black/20 hover:bg-[#a3e635]/10 hover:border-[#a3e635]/40 text-muted-foreground hover:text-[#a3e635] transition-all disabled:opacity-25 text-[7px] font-mono tracking-wider"
                  >
                    ASN
                  </button>
                  {copySourcePad !== null && (
                    <button
                      ...
                      title="Paste sample"
                      className="h-5 w-5 flex items-center justify-center rounded-sm border border-border/40 bg-black/20 hover:bg-[#a3e635]/10 hover:border-[#a3e635]/40 text-muted-foreground hover:text-[#a3e635] transition-all"
                    >
