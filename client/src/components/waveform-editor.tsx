                    ...
                    <div className="flex items-center gap-1 text-[10px]">
                      <button
                        ...
                        className={`w-4 h-4 rounded-none flex items-center justify-center font-bold transition-colors ${
                          track.armed ? 'bg-[#ff2200] text-white' : 'bg-[#1a1a1a] text-[#444] hover:text-[#888]'
                        }`}
                      >
                        R
                      </button>
      ...
      <div className="flex items-center gap-2 px-3 py-2 border-t" style={{ background: '#0c0c0c', borderColor: '#222' }}>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <input
            ...
            className="w-12 bg-black/40 border border-[#222] text-[11px] text-center text-foreground/80 font-mono px-1 py-0.5"
          />
