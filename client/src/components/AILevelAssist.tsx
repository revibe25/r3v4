    ...
    >
      ...
      >
        ...
        <circle
          ...
          r={radius}
          fill={knobColor}
          stroke={isClipping ? '#ef4444' : '#374151'}
          strokeWidth={1.5}
        />
      ...
      {hasSuggestion && (
        <div className="flex gap-1 mt-0.5">
          <button
            ...
            className="px-2 py-0.5 text-[10px] font-medium rounded bg-violet-600/80 hover:bg-violet-600 text-white transition-colors"
            ...
            >
              ...
              <span
                className={`w-1.5 h-1.5 rounded-full ${
                  ...
                  status === 'active' ? 'bg-violet-400 shadow-[0_0_4px_#a855f7]' :
