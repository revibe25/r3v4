...
function ShaderPlane() {
    ...
    return (_jsxs("mesh", { children: [_jsx("planeGeometry", { args: [2, 2] }), _jsx("shaderMaterial", { ref: mat, vertexShader: vertexShader, fragmentShader: fragmentShader, transparent: true, uniforms: {
                    time: { value: 0 },
                    uSub: { value: 0 },
                    uLow: { value: 0 },
                    uMid: { value: 0 },
...
export function VisualEngine() {
    return (_jsx(Canvas, { className: "fixed inset-0 -z-10", children: _jsx(ShaderPlane, {}) }));
}
