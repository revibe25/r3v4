...
const _SidebarContext = React.createContext<SidebarContextProps | null>(null)

function useSidebar() {
  const _context = React.useContext(SidebarContext)
  if (!context) {
...
function SidebarProvider({
  ...
  const _contextValue = React.useMemo<SidebarContextProps>(
    () => ({
      state,
      open,
      setOpen,
