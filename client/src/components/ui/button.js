   ...
   active:shadow-metal-pressed active:translate-y-0.5`, {
    variants: {
        ...
        `,
          ...
          text-foreground shadow-glow-blue
        ...
        `,
          ...
          text-foreground shadow-glow-red
        ...
        `,
          ...
          border-border border-r border-b border-border
          text-foreground shadow-glow-green
        ...
        `,
          ...
          text-foreground shadow-glow-orange
        ...
        `,
          ...
          bg-gradient-to-b from-red-600 via-red-700 to-red-800
          border-red-500 border-r border-b border-red-900
          text-foreground rounded-full shadow-glow-red
        ...
        `,
          ...
          bg-gradient-to-b from-green-600 via-green-700 to-green-800
          border-border border-r border-b border-border
          text-foreground rounded-full shadow-glow-green
...
const Button = React.forwardRef(({ className, variant, size, asChild = false, active, glow, children, ...props }, ref) => {
    const Comp = asChild ? Slot : 'button';
    return (_jsxs(Comp, { className: cn(buttonVariants({ variant, size, className }), active && 'shadow-metal-pressed translate-y-0.5', glow && 'shadow-glow-blue'), ref: ref, ...props, children: [_jsx("span", { className: "absolute inset-0 rounded-md pointer-events-none", children: _jsx("span", { className: "absolute top-0 left-0 right-0 h-1/3 rounded-t-md bg-gradient-to-b from-white/10 to-transparent" }) }), _jsx("span", { className: "relative z-10 flex items-center gap-2", children: children }), active && (_jsx("span", { className: "absolute inset-0 rounded-md bg-background/20 pointer-events-none" }))] }));
});
