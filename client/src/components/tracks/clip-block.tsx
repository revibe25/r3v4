    ...
    >
      ...
      <div className="p-2 flex items-center gap-2 h-full">
        {clip.type === 'midi' ? (
          ...
          <FileAudio className="w-3 h-3 text-white/70 flex-shrink-0" />
        )}
      ...
      {/* Duration Label */}
      <div className="absolute bottom-1 right-2 text-xs text-white/60 pointer-events-none">
      ...
      <div className="absolute bottom-0 left-0 right-0 h-6 opacity-30">
        ...
        <svg width="100%" height="100%" className="opacity-50">
          <rect x="0" y="40%" width="100%" height="20%" fill="currentColor" className="text-white" />
        </svg>
      </div>
    </div>
  );
