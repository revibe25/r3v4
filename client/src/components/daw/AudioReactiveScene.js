...
export const AudioReactiveScene = memo(({ fftRef, visible, accent = 'var(--status-warn)' }) => {
    ...
    useEffect(() => {
        ...
        cubeGeo.setAttribute('aFFT', fftAttr);
        ...
        const animate = () => {
            ...
            if (!visible)
                return; // skip render when hidden (save GPU)
            ...
            for (let i = 0; i < COUNT; i++) {
                const binIdx = i % 128;
                fftAttr.array[i] = fftData[binIdx];
            }
