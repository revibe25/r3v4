...
const BAR_COUNT = 128;
export const WaveformMesh = memo(({ fftRef, color = 'var(--status-warn)', height = 48, mode = 'waveform', playing = false, }) => {
    ...
    useEffect(() => {
        ...
        const camera = new THREE.OrthographicCamera(-BAR_COUNT / 2, BAR_COUNT / 2, // left, right
