...
export const TimeSavingsPanel = memo(function TimeSavingsPanel({
  ...
  if (!expanded) {
    ...
    return (
      <div className="flex items-center gap-3 px-3 py-1.5 rounded-lg bg-black/40 border border-white/5">
  ...
  return (
    <div className="flex flex-col gap-4 p-4 rounded-xl bg-black/60 border border-white/10">
      {/* Headline metric */}
