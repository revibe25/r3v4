...
const TIER_ORDER = { explorer: 0, creator: 1, pro_artist: 2 };
export function ProtectedRoute({ children, minTier = 'explorer' }) {
    ...
    if (loading) {
        return (_jsx("div", { style: {
                ...
                fontFamily: '"JetBrains Mono", monospace',
                            ...
                            margin: '0 auto 16px',
                        } }), _jsx("p", { style: { color: 'var(--dj-dim)', fontSize: 11, letterSpacing: '0.2em' }, children: "INITIALISING" }), _jsx("style", { children: `@keyframes spin { to { transform: rotate(360deg); } }` })] }) }));
    }
    ...
    if (TIER_ORDER[tier] < TIER_ORDER[minTier]) {
        return (_jsxs("div", { style: {
                ...
                gap: 16,
            }, children: [_jsxs("p", { style: { color: 'var(--status-warn)', fontSize: 12, letterSpacing: '0.2em' }, children: [minTier.toUpperCase(), " TIER REQUIRED"] }), _jsxs("p", { style: { color: 'var(--dj-dim)', fontSize: 10 }, children: ["This feature requires the ", minTier, " plan or higher."] }), _jsx("a", { href: "/pricing", style: {
                        padding: '6px 16px',
