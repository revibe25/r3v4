...
function renderMessage(text, accentColor) {
        ...
        if (part.startsWith("```")) {
            ...
            return (_jsxs("div", { style: {
                    ...
                    overflow: "hidden",
                            ...
                            whiteSpace: "pre",
                        }, children: _jsx("code", { children: code }) })] }, i));
        }
        const inlineParts = part.split(/(`[^`]+`)/g);
        return (_jsx("span", { children: inlineParts.map((ip, j) => {
                if (ip.startsWith("`") && ip.endsWith("`")) {
                    return (_jsx("code", { style: {
                            ...
                            fontSize: 12,
                            color: accentColor,
                        }, children: ip.slice(1, -1) }, j));
                }
                return _jsx("span", { style: { whiteSpace: "pre-wrap" }, children: ip }, j);
            }) }, i));
    });
}
// ─── Quick Action Chip ────────────────────────────────────────────────────────
function QuickChip({ label, color, onClick }) {
    ...
    return (_jsx("button", { onClick: onClick, onMouseEnter: () => setHov(true), onMouseLeave: () => setHov(false), style: {
...
function Bubble({ msg, agent }) {
    ...
    return (_jsxs("div", { style: {
            ...
            alignItems: "flex-start",
                    ...
                    fontFamily: "monospace",
                }, children: agent.icon })), _jsxs("div", { style: { maxWidth: "78%", position: "relative" }, children: [_jsx("div", { style: {
                            ...
                            ? _jsx("span", { style: { whiteSpace: "pre-wrap" }, children: msg.content })
                            : renderMessage(msg.content, agent.color) }), !isUser && (_jsx("button", { onClick: copy, style: {
...
function TypingDots({ agent }) {
    return (_jsxs("div", { style: { display: "flex", gap: 10, marginBottom: 18, alignItems: "center" }, children: [_jsx("div", { style: {
                    width: 30, height: 30, borderRadius: "50%",
                    background: `${agent.color}15`, border: `1px solid ${agent.color}40`,
                    display: "flex", alignItems: "center", justifyContent: "center",
                    fontSize: 13, color: agent.color, flexShrink: 0,
                    fontFamily: "monospace",
                }, children: agent.icon }), _jsx("div", { style: {
...
// ─── Chat Panel ───────────────────────────────────────────────────────────────
function ChatPanel({ agent, messages, setMessages, }) {
    ...
    return (_jsxs("div", { style: { display: "flex", flexDirection: "column", height: "100%" }, children: [_jsxs("div", { style: {
                    ...
                    flexShrink: 0,
                    background: T.z950,
                }, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 10, marginBottom: 4 }, children: [_jsx("div", { style: {
                                ...
                                }, children: agent.icon }), _jsxs("div", { children: [_jsx("div", { style: {
                                            fontSize: 14, fontWeight: 700,
                                            color: agent.color,
                                            fontFamily: "'JetBrains Mono', monospace",
                                            letterSpacing: "0.04em",
                                        }, children: agent.name }), _jsx("div", { style: {
                                            fontSize: 11, color: T.z500,
                                            fontFamily: "Inter, sans-serif",
                                        }, children: agent.role })] }), _jsx("div", { style: { flex: 1 } }), _jsx("div", { style: {
                                    fontSize: 9, color: T.z600,
                                    fontFamily: "'JetBrains Mono', monospace",
                                    textAlign: "right", lineHeight: 1.8,
                                }, children: agent.sources.join(" · ") })] }), _jsx("div", { style: {
                            display: "flex", gap: 6, flexWrap: "wrap",
                            paddingTop: 8,
                        }, children: agent.quickActions.map(qa => (_jsx(QuickChip, { label: qa, color: agent.color, onClick: () => void send(qa) }, qa))) })] }), _jsxs("div", { style: {
                    flex: 1, overflowY: "auto",
                    padding: "20px 20px 0",
                }, children: [isEmpty && (_jsxs("div", { style: {
                            ...
                            height: "100%", gap: 12, opacity: 0.5,
                                    ...
                                    fontFamily: "'JetBrains Mono', monospace",
                                    letterSpacing: "0.1em",
                                }, children: "ARTIFACT-BOUND EXPERT" }), _jsxs("div", { style: {
                                    fontSize: 11, color: T.z600,
                                    fontFamily: "Inter, sans-serif",
                                    textAlign: "center", maxWidth: 280, lineHeight: 1.7,
                                }, children: ["Knowledge locked to: ", agent.sources.join(", "), ".", _jsx("br", {}), "Use quick actions above or type your question."] })] })), messages.map((msg, i) => (_jsx(Bubble, { msg: msg, agent: agent }, i))), loading && _jsx(TypingDots, { agent: agent }), error && (_jsxs("div", { style: {
                            padding: "10px 14px",
                            background: `${T.red}12`,
                    ...
                    background: T.z950,
                        ...
                        padding: "8px 8px 8px 14px",
                    }, children: [_jsx("textarea", { ref: textareaRef, value: input, onChange: onInput, onKeyDown: onKey, placeholder: `Ask ${agent.name}… (Shift+Enter for newline)`, rows: 1, style: {
                            ...
                            } }), _jsx("button", { onClick: () => void send(), disabled: !input.trim() || loading, style: {
...
export function AgentSuite() {
    ...
    const setMsgs = (updated) => setAllMessages(prev => ({ ...prev, [activeId]: updated }));
    const counts = {};
                    ...
                    overflow: "hidden",
                            ...
                            overflowY: "auto",
                                    ...
                                    flexShrink: 0,
                                            ...
                                            marginBottom: 4,
                                        }, children: "R3 V4 \u00B7 ADMIN" }), _jsx("div", { style: {
                                            fontSize: 13, fontWeight: 700,
                                            color: T.acid, fontFamily: "'JetBrains Mono', monospace",
                                            letterSpacing: "0.06em",
                                            textShadow: `0 0 20px ${T.acid}60`,
                                        }, children: "EXPERT AGENTS" }), _jsxs("div", { style: {
                                            fontSize: 9, color: T.z600,
                                            fontFamily: "'JetBrains Mono', monospace",
                                            marginTop: 3, letterSpacing: "0.1em",
                                        }, children: [AGENTS.length, " AGENTS \u00B7 ARTIFACT-BOUND"] })] }), _jsx("div", { style: { flex: 1, padding: "8px 6px", overflowY: "auto" }, children: CATEGORIES.map(cat => {
                                    const catAgents = AGENTS.filter(a => a.category === cat);
                                    if (catAgents.length === 0)
                                        return null;
                                    return (_jsxs("div", { style: { marginBottom: 6 }, children: [_jsx("div", { style: {
                                                    fontSize: 9, letterSpacing: "0.15em",
                                                    color: T.z600, padding: "6px 8px 4px",
                                                    fontFamily: "'JetBrains Mono', monospace",
                                                }, children: cat }), catAgents.map(agent => {
                                                const isActive = agent.id === activeId;
                                                const msgCount = counts[agent.id] ?? 0;
                                                return (_jsxs("button", { onClick: () => setActiveId(agent.id), style: {
                                                        ...
                                                        if (!isActive) {
                                                            ...
                                                            e.currentTarget.style.borderColor = "transparent";
                                                            ...
                                                            }, children: agent.icon }), _jsx("div", { style: { flex: 1, minWidth: 0, textAlign: "left" }, children: _jsx("div", { style: {
                                                                ...
                                                                }, children: agent.name }) }), msgCount > 0 && (_jsx("div", { style: {
                                    ...
                                    }, children: ["ARTIFACT-BOUND \u00B7 NO HALLUCINATION", _jsx("br", {}), "Wire.txt \u00B7 CLAUDE.md \u00B7 llpte.md", _jsx("br", {}), "agents.md \u00B7 auth.md \u00B7 workflow.md", _jsx("br", {}), "testing.md \u00B7 patch-scripts.md \u00B7 SKILL.md"] }) })] }), _jsx("div", { style: {
                            flex: 1, display: "flex", flexDirection: "column",
                            background: T.z950, minWidth: 0, overflow: "hidden",
                        }, children: _jsx(ChatPanel, { agent: activeAgent, messages: msgs, setMessages: setMsgs }, activeId) })] })] }));
}
