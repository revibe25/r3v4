...
import { instrumentEngine, PAD_KEYS, PIANO_KEYS } from '@/audio/core/instrument-engine';
export function useAudioEngine() {
    const [state, setState] = useState(instrumentEngine.state);
    ...
    const loadChannelVST = useCallback(async (channel, vstUrl, workletName) => {
        try {
