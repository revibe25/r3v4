...
function Led({ on, color = '#f59e0b' }: { on: boolean; color?: string }) {
  return (
    <span
      style={{
  ...
  return (
    <div style={{ display: 'flex', flexDirection: 'column', gap: 4 }}>
      <div style={{ display: 'flex', alignItems: 'center', gap: 8 }}>
        <Led on={focused || value.length > 0} color={error ? '#ef4444' : '#f59e0b'} />
      ...
      <input
        ...
        style={{
          background:    '#0d0d0d',
          border:       `1px solid ${error ? '#ef444455' : focused ? '#f59e0b55' : '#1e1e1e'}`,
          borderRadius:  3,
          padding:      '8px 12px',
          color:         '#e5e5e5',
          fontSize:      12,
          ...
          boxShadow:     focused ? `0 0 8px #f59e0b11` : 'none',
        }}
      />
    </div>
  );
      ...
      >
        ...
        <div
          style={{
            ...
            borderRadius:  6,
            overflow:     'hidden',
            boxShadow:    '0 0 40px rgba(0,0,0,0.8), 0 0 1px #f59e0b22',
          }}
        >
          {/* Panel header strip */}
          <div
          ...
          <form onSubmit={submit} style={{ padding: '24px 20px', display: 'flex', flexDirection: 'column', gap: 16 }}>
            ...
            <button
              ...
              style={{
                padding:       '10px 0',
                background:    loading ? '#111' : '#f59e0b18',
                border:       `1px solid ${loading ? '#222' : '#f59e0b55'}`,
                borderRadius:  3,
                color:         loading ? '#444' : '#f59e0b',
                fontSize:       10,
